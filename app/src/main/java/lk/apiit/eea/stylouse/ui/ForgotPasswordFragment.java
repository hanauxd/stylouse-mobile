...
import static lk.apiit.eea.stylouse.databinding.FragmentForgotPasswordBinding.inflate;
...
public class ForgotPasswordFragment extends RootBaseFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        validation.addValidation(binding.email, EMAIL_ADDRESS, getString(R.string.error_email));
    }
    ...
    private ApiResponseCallback resetCallback = new ApiResponseCallback() {
        ...
        public void onSuccess(Response<?> response) {
            ...
            navigate(navController, R.id.action_forgotPasswordFragment_to_otpFragment, bundle);
        }
